...
# ==================================================================
# СИСТЕМА ЛЕТОИСЧИСЛЕНИЯ (см. docs/lore/timekeeping_system.md)
# ==================================================================
...
# ==================================================================
# МАРОДЕРСТВО И ПОЛЯ БРАНИ (см. docs/game_mechanics/collecting_weapons_after_battle.md)
# ==================================================================

# Количество тактов, в течение которых поле брани сохраняет трофеи до полного разложения
DEFAULT_BATTLEFIELD_DECAY_TICKS: Final[int] = 6
