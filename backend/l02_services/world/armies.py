...
class StartingArmyBuilder:
    ...
    def build(self, faction: Faction, capital_hex: HexCoordinates) -> StrategicArmy:
        ...
        """
        squads = [
            *self._recruit_squads(faction.race, WORKER_UNIT_TIER, STARTING_ARMY_WORKER_SQUADS),
    ...
    def _cheapest_roster_entry(self, race: FactionRace, tier: int) -> Optional[RosterEntry]:
        """
