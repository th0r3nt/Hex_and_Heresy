...
from backend.l01_domain.factions.models.buildings import (
    Building,
    ConstructedBuilding,
    Headquarters,
    RegionalHall,
...
from backend.l01_domain.factions.models.legendary import LegendaryLordTemplate
from backend.l01_domain.factions.models.lord import Lord
from backend.l01_domain.maps.constants import TerritoryZoneType
from backend.l01_domain.maps.models.strategic import hex_zone_id
...
from backend.l01_domain.world.models.setup import FactionSetupConfig, RulerSetupConfig
from backend.l02_services.world.layout import FactionPlacement
...
class FactionBuilder:
    ...
    def _settle_allied_lands(faction: Faction, placement: FactionPlacement) -> None:
        ...
        первого уровня.
        """
        hall_name = REGIONAL_HALL_NAME_BY_RACE.get(faction.race, DEFAULT_REGIONAL_HALL_NAME)
    ...
    def _erect_starting_buildings(self, faction: Faction, placement: FactionPlacement) -> None:
        """
    ...
    def _pick_producer(self, race: FactionRace, resource: ResourceType) -> Optional[Building]:
        """
