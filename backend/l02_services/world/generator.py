...
from backend.l02_services.world.armies import StartingArmyBuilder
from backend.l02_services.world.factions import FactionBuilder
from backend.l02_services.world.layout import plan_placements
from backend.l02_services.world.no_mans_land import NoMansLandPopulator
...
class WorldGenerator:
    ...
    async def _publish_generated(self, world: WorldState, config: NewGameConfig) -> None:
        """
