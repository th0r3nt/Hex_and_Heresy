...
from backend.l01_domain.world.constants import VictoryType
from backend.l01_domain.world.models.events import GlobalEvent
from backend.l01_domain.world.models.gameflow import (
...
from backend.l01_domain.world.models.setup import NewGameConfig
...
from backend.l02_services.gameflow.guards import (
...
from backend.l02_services.gameflow.states import GameFlowTrigger, GameState
...
class GameFlowFacade:
    ...
    async def start_new_game(self, config: Optional[NewGameConfig] = None) -> GameState:
        """
