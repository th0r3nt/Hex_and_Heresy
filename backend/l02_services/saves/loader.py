...
from backend.l01_domain.exceptions.saves import SaveDataCorruptedError, SaveNotFoundError
...
class WorldStateLoader:
    ...
    def _repair(self, world_state: WorldState) -> None:
        ...
        for garrison in world_state.garrisons.values():
            if garrison.is_locked_in_resolution and garrison.zone_id not in besieged_zone_ids:
