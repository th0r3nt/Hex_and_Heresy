...
from backend.l01_domain.army.models.card.squad import Squad
from backend.l01_domain.army.models.characters.commanders import Commander
from backend.l01_domain.army.models.characters.heroes import Hero
from backend.l01_domain.combat.models.reports import TacticalTurnReport
from backend.l01_domain.combat.models.state import TacticalBattleState
from backend.l01_domain.exceptions.factions import (
    FactionNotFoundError,
    GarrisonNotFoundError,
)
from backend.l01_domain.exceptions.workers import InvalidAssignmentTargetError
from backend.l01_domain.exceptions.world import NoArmiesLockedForBattleError
from backend.l01_domain.factions.constants import BorderTownResolutionType
from backend.l01_domain.factions.models.border_town import (
    BorderTown,
    BorderTownOperation,
)
from backend.l01_domain.factions.models.faction import Faction
from backend.l01_domain.factions.models.garrison import Garrison
from backend.l01_domain.factions.models.workers import WorkerAssignment
from backend.l01_domain.maps.constants import HexVisibilityState
from backend.l01_domain.maps.models.strategic import HexCoordinates, hex_line
from backend.l01_domain.protocols.events import EventBusProtocol
from backend.l01_domain.protocols.gamedata import GameDataRepositoryProtocol
from backend.l01_domain.world.models.reports import GlobalTurnReport
from backend.l01_domain.world.models.state import WorldState
from backend.l01_domain.world.models.victory import VictoryProgress
from backend.l01_domain.world.models.visibility import FactionVisionMap
from backend.l02_services.mechanics.settlements.facade import SettlementsFacade
from backend.l02_services.mechanics.victory.facade import VictoryFacade
from backend.l02_services.mechanics.vision.facade import VisionFacade
from backend.l02_services.turns.strategic.garrison import GarrisonService
from backend.l02_services.turns.strategic.orchestrator import (
    StrategicTurnOrchestrator,
)
from backend.l02_services.turns.strategic.workers.expedition import (
    ExpeditionWorkerService,
)
from backend.l02_services.turns.strategic.workers.stationary import (
    StationaryWorkerService,
)
from backend.l02_services.turns.tactical.orchestrator import TacticalTurnOrchestrator
from backend.utils.event.registry import GameEvents
...
class TurnsFacade:
    ...
    def list_border_towns(self, world_state: WorldState, faction_id: str) -> list[BorderTown]:
        """
    ...
    def get_border_town_operation(
        ...
        """
        return self._settlements.get_town_operation(world_state=world_state, town_id=town_id)
    ...
    def get_faction_vision(self, world_state: WorldState, faction_id: str) -> FactionVisionMap:
        """
    ...
    def get_world_view(self, world_state: WorldState, faction_id: str) -> WorldState:
        ...
        """
        return self._vision.build_world_view(world_state=world_state, faction_id=faction_id)
