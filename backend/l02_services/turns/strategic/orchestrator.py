...
from backend.l02_services.turns.strategic.economy import StrategicEconomyService
from backend.l02_services.turns.strategic.garrison import GarrisonService
from backend.l02_services.turns.strategic.veterancy import StrategicVeterancyService
from backend.l02_services.turns.strategic.events import StrategicEventsService
from backend.l02_services.turns.strategic.movement import (
...
class StrategicTurnOrchestrator:
    ...
    def __init__(
        ...
        self._settlements_facade = settlements_facade or SettlementsFacade(event_bus=event_bus)
    ...
    async def execute_turn(
        ...
        service_veterancy_report = await self._veterancy_service.process_service_accumulation(
            world_state
        )
