...
from backend.l01_domain.factions.constants import MILITIA_ALLOWED_TIERS
...
from backend.l01_domain.maps.constants import ALLIED_LANDS_RING_RADIUS
...
from backend.l01_domain.world.models.reports import GarrisonStepReport
...
class GarrisonService:
    ...
    def _administrative_zones(self, faction: Faction) -> list[tuple[str, HexCoordinates, int]]:
        """
