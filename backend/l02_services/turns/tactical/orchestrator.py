...
from backend.l01_domain.army.constants import VETERANCY_KILL_WEIGHT_BY_SIZE
from backend.l01_domain.combat.constants import BattlePhase, TerrainType
from backend.l01_domain.combat.models.effects import TerrainProfile
...
from backend.l01_domain.world.models.battleground import (
    BattlefieldCorpsePile,
    BattlefieldLootSite,
)
from backend.l02_services.turns.tactical.combat.facade import TacticalCombatService
from backend.l02_services.turns.tactical.initiative import TacticalInitiativeService
from backend.l02_services.turns.tactical.movement import TacticalMovementService
