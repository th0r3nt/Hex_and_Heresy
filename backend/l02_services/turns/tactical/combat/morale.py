...
from backend.l01_domain.army.constants import PANIC_THRESHOLD_MORALE
from backend.l01_domain.army.models.card.squad import Squad
from backend.l01_domain.combat.constants import CORPSE_PILE_UNIT_THRESHOLD, TerrainType
from backend.l01_domain.combat.models.reports import MoraleAndEnvironmentReport
from backend.l01_domain.combat.models.state import TacticalBattleState
from backend.l01_domain.combat.resolution import calculate_effective_corpse_weight
from backend.l01_domain.maps.models.tactical import CellCoordinates, cell_neighbors
