...
from backend.l01_domain.army.constants import EquipmentTag
from backend.l01_domain.combat.models.effects import TerrainProfile
from backend.l01_domain.combat.models.reports import RangedCombatReport
from backend.l01_domain.combat.models.state import TacticalBattleState, TacticalCellState
from backend.l01_domain.combat.visibility import resolve_visibility_range_cells
from backend.l01_domain.maps.models.tactical import (
    CellCoordinates,
