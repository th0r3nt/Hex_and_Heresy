...
from backend.l01_domain.world.models.reports import BorderTownResolutionStepReport
from backend.l01_domain.world.models.state import WorldState
from backend.l02_services.mechanics.settlements.border_towns.foundation import (
    BorderTownFoundationService,
)
from backend.l02_services.mechanics.settlements.border_towns.resolution import (
...
class SettlementsFacade:
    ...
    def get_town_operation(
        ...
        """
        return self._resolution.get_town_operation(world_state=world_state, town_id=town_id)
