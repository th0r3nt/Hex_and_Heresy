...
from backend.l02_services.mechanics.settlements.border_towns.common import (
    require_army,
    require_town_on_map,
)
from backend.l02_services.mechanics.settlements.border_towns.outcomes import (
    BorderTownOutcomes,
)
