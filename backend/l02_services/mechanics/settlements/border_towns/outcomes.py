...
from backend.l02_services.mechanics.settlements.border_towns.common import release_hex
...
class BorderTownOutcomes:
    ...
    @staticmethod
    def _rebind_garrison(world_state: WorldState, zone_id: str, new_faction_id: str) -> None:
        """
