...
from backend.l01_domain.exceptions.diplomacy import AmbassadorUnavailableError
...
from backend.l01_domain.factions.models.diplomacy.negotiations import (
...
from backend.l01_domain.world.models.reports import DiplomacyTickReport
from backend.l01_domain.world.models.state import WorldState
from backend.l02_services.mechanics.diplomacy.ambassador import AmbassadorService
from backend.l02_services.mechanics.diplomacy.messenger import DispatchService
from backend.l02_services.mechanics.diplomacy.negotiations import NegotiationService
from backend.l02_services.mechanics.diplomacy.pacts import PactUpkeepService
...
class DiplomacyFacade:
    ...
    async def pay_tribute(
        ...
        """
        relation = world_state.get_or_create_relation(payer_faction_id, receiver_faction_id)
    ...
    def _require_negotiations(self) -> NegotiationService:
        if self._negotiations is None:
            raise ValueError("Переговоры недоступны: DiplomacyFacade собран без LLM-клиента")
        return self._negotiations

    def _require_ambassador(self, world_state: WorldState, ambassador_id: str) -> Ambassador:
        """
