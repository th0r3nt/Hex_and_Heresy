...
from backend.l01_domain.world.models.reports import VisionStepReport
...
class VisionFacade:
    ...
    def get_vision_map(self, world_state: WorldState, faction_id: str) -> FactionVisionMap:
        """
    ...
    def build_world_view(self, world_state: WorldState, faction_id: str) -> WorldState:
        """
    ...
    async def _publish_vision_updated(
        ...
        await self._event_bus.publish(
            ...
            newly_explored_hexes=sorted(newly_explored, key=lambda coord: (coord.q, coord.r)),
        )
