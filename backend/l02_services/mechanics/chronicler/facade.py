...
from backend.l01_domain.exceptions.chronicler import (
...
from backend.l01_domain.protocols.chronicler import ChroniclerRepositoryProtocol
from backend.l01_domain.protocols.events import EventBusProtocol
from backend.l01_domain.protocols.llm import (
    ContextBuilderProtocol,
    LLMClientProtocol,
    PromptBuilderProtocol,
)
from backend.l01_domain.world.constants import (
    CHRONICLE_HISTORY_PAGE_SIZE,
    CHRONICLE_MIN_SQUADS_PER_SIDE,
)
from backend.l01_domain.world.models.battle_log import BattleDossier, BattleSide
...
from backend.l01_domain.world.models.victory import VictoryEvaluationResult
from backend.l02_services.mechanics.chronicler.archives.fallens import HallOfFallen
from backend.l02_services.mechanics.chronicler.archives.history import ChronicleArchive
from backend.l02_services.mechanics.chronicler.generation.battles import BattleLogCollector
from backend.l02_services.mechanics.chronicler.generation.chronicles import ChronicleGenerator
from backend.l02_services.mechanics.chronicler.generation.rumors import RumorGenerator
...
class ChroniclerFacade:
    ...
    def __init__(
        ...
        if llm_client is not None:
            ...
            self._chronicles = ChronicleGenerator(llm_client, prompt_builder, context_builder)
    ...
    async def _publish_finale(self, finale: FinaleChronicle) -> None:
        ...
        await self._event_bus.publish(
            ...
            victory_type=(None if finale.victory_type is None else finale.victory_type.value),
