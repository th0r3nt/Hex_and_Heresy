...
from backend.l01_domain.army.constants import StrategicMovementPace, UnitSizeCategory
...
from backend.l01_domain.army.models.characters.traits import Trait, get_trait
...
from backend.l01_domain.factions.models.lord import Lord, LordStrategicBias
from backend.l01_domain.llm.tools.definitions.game_master import (
    CREATE_ADVISOR,
    CREATE_COMMANDER,
    CREATE_HERO,
    CREATE_LORD,
...
from backend.l01_domain.llm.tools.schemas.game_master import (
    CreateAdvisorParams,
...
from backend.l02_services.mechanics.game_master.custom.advisers import CustomAdvisor
...
class GameMasterToolHandlers:
    ...
    async def create_commander(
        ...
        await self._publish_character_created(
            commander.id, "commander", commander.name, faction_id
        )
