...
from backend.l01_domain.factions.models.diplomacy.pacts import (
    NonAggressionPact,
    RightOfPassagePact,
    TradeAgreement,
)
from backend.l01_domain.llm.tools.definitions.diplomacy import (
    DECLARE_WAR,
    DEMAND_TRIBUTE,
    ESTABLISH_BORDERS,
...
from backend.l01_domain.llm.tools.schemas.diplomacy import (
    DeclareWarParams,
    DemandTributeParams,
...
class DiplomacyToolHandlers:
    ...
    def register(self, executor: ToolExecutor) -> None:
        ...
        executor.register_handler(ESTABLISH_RIGHT_OF_PASSAGE, self.establish_right_of_passage)
