...
from backend.l01_domain.llm.tools.definitions.general import REPLY, STAY_SILENT
from backend.l01_domain.llm.tools.schemas.general import ReplyParams, StaySilentParams
