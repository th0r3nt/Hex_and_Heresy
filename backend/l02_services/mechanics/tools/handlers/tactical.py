...
from backend.l01_domain.exceptions.combat import OrderNotAllowedError
from backend.l01_domain.llm.tools.definitions.tactical import (
    ORDER_SQUAD_HOLD,
    ORDER_SQUAD_MOVE,
    ORDER_SQUAD_REACTION,
)
from backend.l01_domain.llm.tools.schemas.tactical import (
...
class TacticalToolHandlers:
    ...
    @staticmethod
    def _locate_squad(battle_state: TacticalBattleState, squad_id: str) -> TacticalCellState:
        """
