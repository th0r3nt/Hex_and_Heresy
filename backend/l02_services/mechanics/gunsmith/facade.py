...
from backend.l01_domain.exceptions.llm import InvalidToolCallError
from backend.l01_domain.factions.models.faction import Faction
from backend.l01_domain.llm.prompts import PromptCatalog, get_faction_prompt_key
from backend.l01_domain.llm.tools.definitions.gunsmith import (
    DRAFT_BLUEPRINT,
    REJECT_BLUEPRINT,
)
...
from backend.l02_services.mechanics.gunsmith.blueprints import BlueprintRegistry
from backend.l02_services.mechanics.gunsmith.crafting import (
    LLMGunsmithResponse,
    StatPriorities,
)
...
class GunsmithFacade:
    ...
    async def _refuse(self, faction_id: str, master_reply: str) -> tuple[None, str]:
        """
