...
from backend.l02_services.gameflow.guards import ActionForbiddenInCurrentStateError
from backend.l02_services.gameflow.states import GameState
from backend.l04_api.http.errors import (
...
def test_unmapped_domain_error_is_server_error():
    ...
    assert resolve_status_code(UnmappedError("нечто")) == status.HTTP_500_INTERNAL_SERVER_ERROR
