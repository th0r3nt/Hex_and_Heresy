...
async def test_events_outside_the_list_do_not_leak(bridge: tuple[Any, FakeManager, Any]):
    """
...
async def test_domain_models_are_unpacked_for_json(bridge: tuple[Any, FakeManager, Any]):
    bus, manager, _ = bridge
...
async def test_unserializable_field_is_skipped_not_fatal(bridge: tuple[Any, FakeManager, Any]):
    """
...
def test_connection_is_taken_off_the_books_after_disconnect(app: FastAPI, client: TestClient):
