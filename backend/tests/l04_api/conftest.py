...
from backend.l03_infrastructure.gamedata.loader import StaticGameDataRegistry
...
def container(static_registry: StaticGameDataRegistry) -> FakeContainer:
    ...
    world_generator = WorldGenerator(gamedata=static_registry, vision_facade=vision_facade)
