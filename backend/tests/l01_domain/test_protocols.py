"""
Тесты соответствия протоколам backend/l01_domain/protocols/
"""
...
from backend.l01_domain.protocols.llm import LLMClientProtocol
from backend.l01_domain.protocols.saves import SaveGameRepositoryProtocol
