...
from backend.l01_domain.factions.models.buildings import Headquarters, RegionalHall
...
def test_each_level_opens_one_building_slot(town: BorderTown, level: int, expected_slots: int):
...
def test_losing_a_claimed_land_leaves_the_town_standing(faction: Faction, town: BorderTown):
