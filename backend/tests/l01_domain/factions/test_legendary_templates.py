"""
Тесты для backend/l01_domain/factions/models/legendary.py
...
from backend.l01_domain.army.models.characters.commanders import CommanderCharacteristics
...
from backend.l01_domain.factions.models.lord import LordStrategicBias
