...
from backend.l01_domain.factions.constants import MAX_BORDER_TOWN_LEVEL
...
class TestDominationProgress:
    def test_all_enemies_defeated_completes_the_branch(self):
        progress = _progress(domination_defeated_factions=2, domination_total_enemies=2)
    ...
    def test_last_standing_enemy_blocks_the_branch(self):
        progress = _progress(domination_defeated_factions=1, domination_total_enemies=2)
    ...
    def test_solitude_is_not_a_victory(self):
        ...
        progress = _progress(domination_defeated_factions=0, domination_total_enemies=0)
