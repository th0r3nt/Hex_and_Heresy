"""
Тесты для backend/l01_domain/world/models/timekeeping.py
"""

import pytest

from backend.l01_domain.combat.constants import TimeOfDay
from backend.l01_domain.world.constants import DAYS_PER_CYCLE, GREY_HOURS_COUNT, HOURS_PER_DAY
from backend.l01_domain.world.models.timekeeping import GameTime

from backend.l01_domain.exceptions.timekeeping import TimeRewindForbiddenError
