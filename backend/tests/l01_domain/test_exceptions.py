"""
Модульные тесты для иерархии доменных исключений backend/l01_domain/exceptions/.
...
from backend.l01_domain.exceptions.army import (
    ArmyError,
...
from backend.l01_domain.exceptions.timekeeping import (
    TimeRewindForbiddenError,
    TimekeepingError,
)
from backend.l01_domain.exceptions.world import BattlefieldDepletedError, WorldStateError
