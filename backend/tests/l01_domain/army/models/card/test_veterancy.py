"""
Тесты для backend/l01_domain/army/models/card/veterancy.py
"""

import pytest
from pydantic import ValidationError

from backend.l01_domain.army.models.card.veterancy import (
    MechanicalModifier,
    VeterancyStatus,
)
...
class TestMechanicalModifier:
    ...
    def test_can_represent_percentage_bonus(self):
        modifier = MechanicalModifier(
            stat_name=StatName.DAMAGE, value=15.0, is_percentage=True
        )
