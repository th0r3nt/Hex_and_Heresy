...
from backend.l01_domain.army.models.characters.artifacts import HeroArtifact
...
from backend.l01_domain.common import (
    CharacterGenerationType,
    MechanicalModifier,
    StatName,
)
from backend.l01_domain.exceptions.army import HeroLevelTooLowError, NegativeExperienceError
