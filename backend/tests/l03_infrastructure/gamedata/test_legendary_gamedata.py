...
from backend.gamedata.baronial_troops.common import BaronialLordId
from backend.gamedata.congregation_of_the_meteorite.common import CongregationHeroId
from backend.gamedata.elfs.common import ElfsCommanderId
from backend.gamedata.greenskins.common import GreenskinsLordId
from backend.gamedata.humans.common import HumanLordId, HumanRosterId
from backend.gamedata.mercenaries.common import MercenaryHeroId
from backend.gamedata.world.common import PointOfInterestId
from backend.l01_domain.army.models.characters.traits import TRAITS_CATALOG
...
from backend.l03_infrastructure.gamedata.loader import build_static_registry
from backend.l03_infrastructure.llm.prompt.catalog import resolve_prompt_key
            ...
            for entry in registry.list_faction_roster(race.value):
                ...
                for equipment_id in (entry.weapon_id, entry.armor_id, entry.accessory_id):
                    if (
                        ...
                        and registry.get_equipment(equipment_id) is None
                    ):
