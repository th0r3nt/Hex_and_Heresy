...
from backend.l01_domain.factions.models.buildings import RegionalHall
...
@pytest.mark.asyncio
async def test_militia_heals_between_assaults(service: GarrisonService, world: WorldState):
