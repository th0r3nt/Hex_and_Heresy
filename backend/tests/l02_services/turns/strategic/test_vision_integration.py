...
class TestVisionInsideTheTurn:
    async def test_turn_fills_the_vision_report(self, world: WorldState, fake_bus):
    ...
    async def test_vision_follows_the_march(self, world: WorldState, basic_squad, fake_bus):
        """
    ...
    async def test_explored_history_survives_the_ticks(self, world: WorldState, fake_bus):
