...
from backend.l01_domain.factions.constants import (
    BorderTownResolutionType,
    BuildingCategory,
    ResourceType,
)
from backend.l01_domain.factions.models.border_town import BorderTown
from backend.l01_domain.factions.models.buildings import Building, ConstructedBuilding
from backend.l01_domain.factions.models.garrison import Garrison
from backend.l01_domain.maps.constants import TerritoryZoneType
...
class TestBorderTownRazingE2E:
    ...
    async def test_razing_holds_the_army_for_three_ticks(
        ...
        horde = StrategicArmy(faction_id=orc_faction.id, name="Орда", current_hex=town_hex)
        ...
        for _ in range(2):
            ...
            assert (
                world.get_garrison(town.zone_id).militia_squads == []
