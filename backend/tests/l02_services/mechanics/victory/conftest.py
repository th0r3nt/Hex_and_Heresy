...
@pytest.fixture
def player() -> Faction:
    return build_faction("humans", "Священная Империя", FactionRace.HUMANS, is_player=True)


@pytest.fixture
def rival() -> Faction:
    return build_faction("greenskins", "Орда Ржавых Клыков", FactionRace.GREENSKINS)
