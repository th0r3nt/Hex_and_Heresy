...
from backend.l01_domain.factions.constants import DiplomaticStance, NegotiationMode
from backend.l01_domain.factions.models.diplomacy.messengers import Dispatch
from backend.l01_domain.llm.models.tools import ToolCall, ToolDefinition
...
from backend.l02_services.mechanics.tools.handlers import (
    DiplomacyToolHandlers,
    GeneralToolHandlers,
)
from backend.tests.l02_services.fakes import (
    FakeContextBuilder,
    FakePromptBuilder,
    LLMReply,
    reply,
