...
from backend.l02_services.mechanics.gunsmith.validation.balance import (
    STAT_COST,
    TIER_BASE_BUDGET,
...
class TestEmptyPriorities:
    ...
    def test_tradeoffs_still_apply_to_a_blank_item(self):
        ...
        """
        stats = EquipmentBalancer.normalize_stats(6, StatPriorities(heavy_weight_tradeoff=5))
