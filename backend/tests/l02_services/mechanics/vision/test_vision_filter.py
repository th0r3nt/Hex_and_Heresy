...
from backend.l01_domain.world.models.points_of_interest import (
    PointOfInterest,
    PointOfInterestBlueprint,
    PointOfInterestCategory,
)
from backend.l01_domain.world.models.state import WorldState
from backend.l02_services.mechanics.vision.calculator import VisionCalculator
from backend.l02_services.mechanics.vision.filter import VisionFilter
from backend.tests.l02_services.mechanics.vision.conftest import (
    PLAYER_CAPITAL,
    RIVAL_CAPITAL,
    add_army,
    add_regional_hall,
...
class TestForeignArmies:
    ...
    def test_own_armies_are_never_hidden(self, vision_filter: VisionFilter, world: WorldState):
    ...
    def test_view_is_an_independent_copy(self, vision_filter: VisionFilter, world: WorldState):
...
class TestForeignVisionMaps:
    def test_view_keeps_only_own_mask(self, vision_filter: VisionFilter, world: WorldState):
        """
