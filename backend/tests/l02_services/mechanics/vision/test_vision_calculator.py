...
from backend.l01_domain.army.models.characters.traits import Trait, TraitCategory
from backend.l01_domain.common import MechanicalModifier, StatName
from backend.l01_domain.factions.constants import DiplomaticStance
from backend.l01_domain.factions.models.diplomacy.messengers import Ambassador
from backend.l01_domain.factions.models.diplomacy.pacts import IntelligenceSharingPact
from backend.l01_domain.factions.models.faction import Faction
from backend.l01_domain.maps.constants import (
    VISION_RADIUS_ARMY,
    VISION_RADIUS_BASE,
...
class TestSettlementVision:
    ...
    def test_unknown_faction_sees_nothing(
        self, calculator: VisionCalculator, world: WorldState
    ):
...
class TestMobileVision:
    def test_army_opens_its_near_circle(self, calculator: VisionCalculator, world: WorldState):
    ...
    def test_lenses_widen_the_army_view(self, calculator: VisionCalculator, world: WorldState):
        ...
        scout = Commander(
            ...
            traits=[
                Trait(
                    ...
                    modifiers=[
                        MechanicalModifier(stat_name=StatName.VISION_RANGE_HEXES, value=2.0)
                    ],
                )
            ],
        )
...
class TestIntelligenceSharing:
    ...
    def test_war_cancels_shared_vision(self, calculator: VisionCalculator, world: WorldState):
