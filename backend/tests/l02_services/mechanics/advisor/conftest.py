...
from backend.l01_domain.llm.tools.definitions.advisor import PROPOSE_ADVISOR_ACTION
...
from backend.l02_services.mechanics.advisor.generation import AdvisorGenerator
from backend.tests.l02_services.fakes import LLMReply, tool_call
