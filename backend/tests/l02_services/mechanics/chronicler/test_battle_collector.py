...
from backend.l01_domain.world.models.battle_log import BattleSide, TurningPointKind
from backend.l02_services.mechanics.chronicler.generation.battles import (
    BattleLogCollector,
    describe_location,
)
...
class TestRenderContext:
    ...
    def test_context_of_a_quiet_battle_has_no_turning_points(
        self, make_report, collector, dossier
    ):
