...
from backend.l01_domain.combat.models.reports import MeleeCombatReport
...
class TestFinaleSubscription:
    @pytest.mark.asyncio
    async def test_game_over_makes_the_chronicler_close_the_book(self, listener, bus, world):
