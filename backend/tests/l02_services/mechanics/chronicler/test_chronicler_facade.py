...
from backend.l01_domain.world.models.chronicle import LLMChronicleResponse
...
class TestChronicleWorthiness:
    def test_large_battle_is_worthy(
    ...
    def test_siege_is_always_worthy(self, facade, world, battle_state, battle_squads, humans):
...
class TestChronicleBattle:
    ...
    async def test_player_faction_sets_the_style(
        ...
        entry = await facade.chronicle_battle(
            world, wipe_defenders(make_report, victor="greenskins")
        )
