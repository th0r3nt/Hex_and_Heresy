...
@pytest.fixture
def facade(fake_llm, fake_bus, fake_prompt_builder, fake_context_builder) -> ChroniclerFacade:
...
class TestRumorGeneration:
    ...
    async def test_model_failure_is_swallowed(
        ...
        generator = RumorGenerator(BrokenLLM(), fake_prompt_builder, fake_context_builder)
