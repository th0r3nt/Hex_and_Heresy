...
from backend.l01_domain.world.models.chronicle import LLMFinaleResponse
...
class TestFinaleWithoutTheModel:
    ...
    @pytest.mark.asyncio
    async def test_failed_generation_does_not_lose_the_finale(self, facade, world, fake_llm):
