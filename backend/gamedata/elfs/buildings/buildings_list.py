...
from backend.l01_domain.factions.models.buildings import BuildingUpgrade
from backend.l01_domain.maps.constants import (
    VISION_RADIUS_WATCHTOWER,
    TerritoryZoneType,
)
from backend.gamedata.elfs.common import ElfsBuildingId, ElfsUnitId
...
BUILDINGS_LIST: dict[str, dict[str, Any]] = {
    ...
    ElfsBuildingId.ESSENCE_EXTRACTORS.value: {
        ...
        "lore_description": "Изящные шпили, которые вытягивают остаточный резонит из почвы и пролитой крови. Только чистая гармония.",
    ...
    ElfsBuildingId.SANCTUARY_OF_BLADES.value: {
        ...
        "lore_description": "Залы, где молодые эльфы много лет оттачивают смертоносный танец с резонитовыми лезвиями.",
    ...
    ElfsBuildingId.ASTRAL_FORGE.value: {
        ...
        "lore_description": "Экипировка выращивается из первичной взвеси под звуки камертонов.",
        "category": BuildingCategory.MILITARY,
        "allowed_zone": TerritoryZoneType.BASE,
        "cost_gold": 150.0,
        "cost_material": 250.0,
    ...
    ElfsBuildingId.MONOLITH_OF_STASIS.value: {
        ...
        "available_upgrades": [],
        "special_rules": "Пробуждение бога: позволяет призвать на поле боя сильнейшего из Небесных полководцев. Наличие этого здания вызывает тревогу у всех остальных фракций в мире.",
    },
    # ==================================================================
    # КУЛЬТУРА И ОБОРОНА
    # ==================================================================
