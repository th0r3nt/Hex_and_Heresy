...
from backend.gamedata.baronial_troops.common import BaronialArmorId, BaronialWeaponId
from backend.gamedata.humans.common import HumanArmorId, HumanWeaponId
