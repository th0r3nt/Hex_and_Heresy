...
from backend.l03_infrastructure.llm.context.blocks.military import build_battle_summary_block
from backend.l03_infrastructure.llm.context.roles.advisor import build_advisor_context
from backend.l03_infrastructure.llm.context.roles.ambassador import build_ambassador_context
from backend.l03_infrastructure.llm.context.roles.chronicler import (
    build_chronicle_context,
    build_rumor_context,
)
from backend.l03_infrastructure.llm.context.roles.commander import build_commander_context
from backend.l03_infrastructure.llm.context.roles.gunsmith import build_gunsmith_context
from backend.l03_infrastructure.llm.context.roles.hero import build_hero_context
from backend.l03_infrastructure.llm.context.roles.lord import build_lord_context
from backend.l03_infrastructure.llm.context.roles.veteran import build_veteran_context
