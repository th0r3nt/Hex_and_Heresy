from backend.l01_domain.factions.constants import ResourceType, TaxPolicyBand
...
def build_faction_block(faction: Faction) -> ContextBlock:
    ...
    if food < 50.0:
        lines.append(
            "Внимание: Фракция страдает от нехватки провизии, войска могут начать голодать."
        )
    if gold < 20.0:
