...
from backend.l03_infrastructure.llm.context.blocks.diplomacy import build_world_wars_block
from backend.l03_infrastructure.llm.context.blocks.faction import build_faction_block
from backend.l03_infrastructure.llm.context.blocks.world import build_world_block
...
def build_chronicle_context(
    ...
    if faction is not None:
        lines.append(f"Ты служишь фракции '{faction.name}': чужие потери считай заслуженными.")
    if dossier.is_siege:
