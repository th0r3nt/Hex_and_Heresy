...
from backend.l01_domain.factions.constants import AmbassadorStatus, NegotiationMode
...
class Dispatch(BaseModel):
    ...
    total_travel_ticks: int = Field(
        default=1, ge=0, description="Длина пути в тактах при отправке"
    )
...
class Ambassador(BaseModel):
    ...
    directive: Optional[str] = Field(
        default=None,
        description="Инструкция игрока, если выбран автоматический режим переговоров",
    )
