...
from backend.l01_domain.maps.constants import VISION_RADIUS_ARMY
...
class StrategicArmy(BaseModel):
    ...
    def vision_radius_hexes(self) -> int:
        ...
        """
        best_squad_bonus = max((squad.vision_bonus_hexes for squad in self.squads), default=0)
        commander_bonus = 0 if self.commander is None else self.commander.vision_range_bonus
