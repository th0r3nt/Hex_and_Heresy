...
from backend.l01_domain.combat.weather import get_weather_combat_effects
...
def resolve_visibility_range_cells(time_of_day: TimeOfDay, weather: WeatherCondition) -> int:
    """
