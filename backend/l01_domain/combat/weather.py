...
from backend.l01_domain.combat.models.effects import CombatEffect
    ...
    if condition == WeatherCondition.HEAVY_RAIN:
        return [
            CombatEffect(
                ...
                modifiers=[
                    MechanicalModifier(
                        stat_name=StatName.RANGED_ACCURACY, value=-0.15, is_percentage=True
                    )
                ],
            ),
            CombatEffect(
                ...
                modifiers=[
                    MechanicalModifier(
                        stat_name=StatName.FIREARM_MISFIRE_CHANCE,
                        value=0.20,
                        is_percentage=True,
                    )
                ],
    ...
    if condition == WeatherCondition.SNOWFALL:
        return [
            CombatEffect(
                ...
                modifiers=[
                    MechanicalModifier(
                        stat_name=StatName.MOVEMENT_SPEED, value=-0.20, is_percentage=True
                    )
                ],
            ),
            CombatEffect(
                ...
                stacking_rule=EffectStackingRule.IGNORE,
                modifiers=[
                    MechanicalModifier(stat_name=StatName.VISIBILITY_RANGE_CELLS, value=-2.0)
                ],
            ),
        ]
    ...
    if condition == WeatherCondition.CLOUDY:
        return [
            CombatEffect(
                ...
                stacking_rule=EffectStackingRule.IGNORE,
                modifiers=[
                    MechanicalModifier(stat_name=StatName.VISIBILITY_RANGE_CELLS, value=-1.0)
                ],
            ),
        ]
    ...
    if condition == WeatherCondition.ASH_STORM:
        return [
            CombatEffect(
                ...
                stacking_rule=EffectStackingRule.IGNORE,
                modifiers=[
                    MechanicalModifier(stat_name=StatName.VISIBILITY_RANGE_CELLS, value=-3.0)
                ],
            ),
            CombatEffect(
    ...
    if condition == WeatherCondition.TOXIC_MIST:
        return [
            ...
            CombatEffect(
                ...
                stacking_rule=EffectStackingRule.IGNORE,
                modifiers=[
                    MechanicalModifier(stat_name=StatName.HP_DRAIN_PER_TICK, value=2.0)
                ],
