...
from backend.l01_domain.army.models.card.equipment import Equipment
from backend.l01_domain.army.models.strategic import StrategicArmy
from backend.l01_domain.factions.models.border_town import (
    BorderTown,
    BorderTownOperation,
)
from backend.l01_domain.factions.models.diplomacy.messengers import (
    Ambassador,
    Dispatch,
)
from backend.l01_domain.factions.models.diplomacy.relation import DiplomaticRelation
...
from backend.l01_domain.maps.models.strategic import HexCoordinates, hex_zone_id
from backend.l01_domain.world.models.battleground import BattlefieldLootSite
from backend.l01_domain.world.models.chronicle import (
    ChronicleEntry,
    FallenRecord,
    FinaleChronicle,
    RumorEntry,
)
from backend.l01_domain.world.models.events import GlobalEvent
from backend.l01_domain.world.models.points_of_interest import PointOfInterest
from backend.l01_domain.world.models.timekeeping import GameTime
from backend.l01_domain.world.models.visibility import FactionVisionMap
from backend.l01_domain.world.models.victory import (
...
class WorldState(BaseModel):
    ...
    def get_or_create_relation(
        ...
        if relation is None:
            relation = DiplomaticRelation(faction_a_id=faction_a_id, faction_b_id=faction_b_id)
    ...
    def get_point_of_interest_at(self, coord: HexCoordinates) -> Optional[PointOfInterest]:
    ...
    def get_hex_visibility(self, faction_id: str, coord: HexCoordinates) -> HexVisibilityState:
