...
from backend.l02_services.gameflow.facade import GameFlowFacade
from backend.l02_services.gameflow.fsm import GameFlowFSM
from backend.l02_services.gameflow.states import GameState
from backend.l02_services.mechanics.advisor.facade import AdvisorFacade
from backend.l02_services.mechanics.chronicler.facade import ChroniclerFacade
from backend.l02_services.mechanics.chronicler.listener import ChroniclerListener
from backend.l02_services.mechanics.diplomacy.facade import DiplomacyFacade
from backend.l02_services.mechanics.game_master.facade import GameMasterFacade
from backend.l02_services.mechanics.gunsmith.facade import GunsmithFacade
from backend.l02_services.mechanics.settlements.facade import SettlementsFacade
from backend.l02_services.mechanics.tools.executor import ToolExecutor
from backend.l02_services.mechanics.tools.factory import build_tool_executor
...
from backend.l02_services.saves.facade import SavesFacade
from backend.l02_services.saves.loader import LoadedSession
from backend.l02_services.turns.facade import TurnsFacade
from backend.l02_services.turns.strategic.orchestrator import StrategicTurnOrchestrator
from backend.l02_services.turns.tactical.orchestrator import TacticalTurnOrchestrator
from backend.l02_services.world.generator import WorldGenerator

from backend.l03_infrastructure.databases.manager import DatabaseManager
from backend.l03_infrastructure.databases.sql.db import SQLDB
from backend.l03_infrastructure.gamedata.loader import (
    SessionGameDataRepository,
    StaticGameDataRegistry,
    build_static_registry,
)
from backend.l03_infrastructure.llm.context.builder import ContextBuilder
from backend.l03_infrastructure.llm.facade import LLMFacade
from backend.l03_infrastructure.llm.prompt.builder import PromptBuilder

from backend.l04_api.http.errors import register_exception_handlers
from backend.l04_api.http.routers import api_router
from backend.l04_api.ws.dispatcher import EventDispatcher
from backend.l04_api.ws.manager import ConnectionManager
from backend.l04_api.ws.router import router as ws_router
from backend.l04_api.ws.visibility import PlayerVisionGate

from backend.utils.event.bus import EventBus
