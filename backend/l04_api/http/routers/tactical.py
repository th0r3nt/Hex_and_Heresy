...
from backend.l04_api.dependencies import Battle, GameFlow, Turns, World
from backend.l04_api.http.schemas.common import OperationResult
from backend.l04_api.http.schemas.tactical import (
    BattleFinishRequest,
    BattleOrdersRequest,
    BattleStartRequest,
)
...
async def start_battle(payload: BattleStartRequest, gameflow: GameFlow) -> TacticalBattleState:
    """
