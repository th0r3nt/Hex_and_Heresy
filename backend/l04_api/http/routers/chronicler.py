...
from backend.l01_domain.world.constants import CHRONICLE_HISTORY_PAGE_SIZE
from backend.l04_api.dependencies import Chronicler, World
from backend.l04_api.http.schemas.chronicler import (
    ArchivePage,
    ChroniclePage,
    FallenPage,
    RumorsPage,
...
async def get_archived_history(chronicler: Chronicler, limit: int = PageLimit) -> ArchivePage:
...
async def get_archived_fallen(chronicler: Chronicler, limit: int = PageLimit) -> ArchivePage:
