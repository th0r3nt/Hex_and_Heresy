...
from backend.l01_domain.factions.models.advisor import AdvisorAnswer, AdvisorDecision
from backend.l04_api.dependencies import Advisor, World
from backend.l04_api.http.schemas.advisor import (
...
async def list_pending_proposals(faction_id: str, advisor: Advisor) -> AdvisorPendingResponse:
