...
from backend.l04_api.dependencies import LLM
from backend.l04_api.http.schemas.common import OperationResult
from backend.l04_api.http.schemas.settings import (
...
async def register_provider(payload: ProviderRegisterRequest, llm: LLM) -> OperationResult:
