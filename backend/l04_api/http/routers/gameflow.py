...
from backend.l04_api.dependencies import GameFlow, World, get_container
from backend.l04_api.http.schemas.gameflow import (
...
async def start_new_game(
    ...
    return NewGameResponse(
        ...
        world=container.turns_facade.get_world_view(world_state=world, faction_id=player.id),
    )
...
async def declare_game_over(payload: GameOverRequest, gameflow: GameFlow) -> GameStateResponse:
