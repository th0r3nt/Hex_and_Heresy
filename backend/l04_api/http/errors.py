...
from backend.l01_domain.exceptions.combat import (
    CellOccupiedError,
    CellOutOfBoundsError,
    InvalidBattlePhaseError,
    OrderNotAllowedError,
)
from backend.l01_domain.exceptions.diplomacy import (
...
from backend.l01_domain.exceptions.maps import (
    HexOutOfBoundsError,
...
from backend.l01_domain.exceptions.world import (
...
from backend.l04_api.http.schemas.common import ErrorResponse
