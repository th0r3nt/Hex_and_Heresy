...
from backend.l01_domain.world.constants import DifficultyLevel, VictoryType
...
class NewGameRequest(BaseModel):
    ...
    player_faction: FactionSetupRequest = Field(
        default_factory=lambda: FactionSetupRequest(race=FactionRace.HUMANS, name="Империя")
    )
    rival_faction: FactionSetupRequest = Field(
        default_factory=lambda: FactionSetupRequest(race=FactionRace.GREENSKINS, name="Орда")
    )
